...
from source_waba_analytics.streams import AdsInsights
from source_waba_analytics.streams.async_job import AsyncJob, InsightAsyncJob
...
def async_manager_mock_fixture(mocker):
    mock = mocker.patch("source_waba_analytics.streams.base_insight_streams.InsightAsyncJobManager")
...
def async_job_mock_fixture(mocker):
    mock = mocker.patch("source_waba_analytics.streams.base_insight_streams.InsightAsyncJob")

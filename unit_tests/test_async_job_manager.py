...
from source_waba_analytics.api import MyFacebookAdsApi
from source_waba_analytics.streams.async_job import InsightAsyncJob, ParentAsyncJob
from source_waba_analytics.streams.async_job_manager import InsightAsyncJobManager
from source_waba_analytics.streams.common import JobException
...
def time_mock_fixture(mocker):
    return mocker.patch("source_waba_analytics.streams.async_job_manager.time")


@pytest.fixture(name="update_job_mock")
def update_job_mock_fixture(mocker):
    return mocker.patch("source_waba_analytics.streams.async_job_manager.update_in_batch")

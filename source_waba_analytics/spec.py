...
GRANULARITY_PATTERN = "^(?:HALF_HOUR|DAILY|MONTHLY)$"
...
class ConnectorConfig(BaseConfig):
    ...
    granularity: str = Field(
        title="Granularity",
        order=10,
        description="How granular you want your data points to be.",
        pattern=GRANULARITY_PATTERN,
        examples=["HALF_HOUR","DAILY","MONTHLY"],
    )

...
from source_waba_analytics.streams.common import retry_pattern
...
class API:
    ...
    @cached_property
    def account(self) -> WhatsAppBusinessAccount:
        """Find current account"""
        return self._find_account(self._account_id)

    @staticmethod
    def _find_account(account_id: str) -> WhatsAppBusinessAccount:
        """Actual implementation of find account"""
        try:
            return WhatsAppBusinessAccount(account_id).api_get()
